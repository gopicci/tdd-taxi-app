...
class TestWebSocket:
    async def test_can_connect_to_server(self, settings):
        # settings fixture of pytest-django, overwrites application settings
    ...
    async def test_driver_alerted_on_request(self, settings):
        ...
        # Every message that is broadcast to the drivers group will be captured on the test_channel.
        channel_layer = get_channel_layer()
